...
// 2020-04-17 17:27:16.535726300 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1587144436;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwAcceptMatch = 0xD23983EC;
constexpr ::std::ptrdiff_t dwAutoAccept = 0xD23983EC;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x26D5C270;

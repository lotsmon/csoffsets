...
// 2020-04-11 03:41:41.513233 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1586576501;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwAutoAccept = 0xD17F83EC;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x278FC0A0;
